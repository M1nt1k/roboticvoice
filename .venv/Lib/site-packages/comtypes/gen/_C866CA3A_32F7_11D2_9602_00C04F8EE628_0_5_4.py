...
__all__ = [
    'STSF_LocalAppData', 'ISpeechLexicon', 'SPEI_END_INPUT_STREAM',
    'eLEXTYPE_PRIVATE17', 'SPSHORTCUTPAIR', 'SDTLexicalForm',
    'SAFT24kHz16BitMono', 'SREInterference', 'DISPID_SPCLangId',
    'DISPID_SRGReset', 'DISPID_SVEVoiceChange', 'DISPID_SGRSTType',
    ...
    'SAFT12kHz8BitStereo', 'ISpeechGrammarRuleStateTransitions',
    'ISpResourceManager', 'DISPID_SGRSTs_NewEnum',
    ...
    'DISPID_SGRSRule', 'SPCT_SUB_DICTATION',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFT32kHz16BitMono',
    'ISpeechRecoGrammar', 'SPEI_MIN_SR', 'SP_VISEME_0', 'UINT_PTR',
    'SPAR_Low', 'SpeechVoicePriority', 'DISPID_SRCBookmark',
    'SAFT44kHz16BitMono', 'eLEXTYPE_RESERVED4',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SPIEnginePrivateData',
    'SVP_9', 'SGLexical', 'SpeechAudioState', 'SREAudioLevel',
    'SPPHRASEREPLACEMENT', 'DISPID_SAFGuid', 'SDA_One_Trailing_Space',
    'DISPID_SVGetVoices', 'DISPID_SRGCmdLoadFromMemory',
    'SPGS_ENABLED', 'DISPID_SLGetWords', 'SASClosed',
    'SPSHT_NotOverriden', 'SVP_21', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechLexicon', 'SAFT16kHz16BitMono', 'ISpNotifySource',
    'ISpMMSysAudio', 'DISPID_SGRsItem', 'DISPID_SGRSTsItem',
    'SPSVerb', 'SAFT11kHz8BitStereo', 'SpStream',
    'DISPID_SPERetainedStreamOffset', 'ISpeechPhraseReplacement',
    'SRATopLevel', 'SFTSREngine', 'SP_VISEME_5', 'SDTAlternates',
    'SPEI_INTERFERENCE', 'DISPID_SVSpeakStream', 'SpFileStream',
    'ISpRecoGrammar', 'DISPID_SVEBookmark', 'SRAONone',
    'SP_VISEME_20', 'SpeechTokenContext', 'SAFTCCITT_uLaw_22kHzMono',
    'SVEStartInputStream', 'SVEVoiceChange', 'SVP_7',
    'DISPID_SOTDataKey', 'SPSEMANTICERRORINFO', 'STSF_AppData',
    'SLTApp', 'SRAORetainAudio', 'SpeechEngineProperties',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPEI_RECO_OTHER_CONTEXT',
    'SPINTERFERENCE', 'SPEI_REQUEST_UI', 'ISpeechPhraseInfoBuilder',
    'DISPID_SPRsCount', 'tagSTATSTG', 'eLEXTYPE_PRIVATE12',
    'eLEXTYPE_PRIVATE15', 'DISPID_SpeechLexiconProns',
    'SpeechRecognitionType', 'SDKLCurrentConfig', 'SVSFlagsAsync',
    'SAFT24kHz8BitStereo', 'SPAS_STOP', 'DISPID_SPPChildren',
    'DISPID_SPACommit', 'SPSModifier', 'DISPID_SPPs_NewEnum',
    'SpMemoryStream', 'DISPID_SVEEnginePrivate', 'ISpXMLRecoResult',
    'DISPID_SGRSAddRuleTransition', 'SPPS_LMA', 'DISPID_SOTDisplayUI',
    'DISPID_SMSADeviceId', 'DISPID_SVVoice', 'ISpRecoResult',
    'DISPID_SMSAMMHandle', 'SpShortcut', 'SAFT12kHz8BitMono',
    'DISPID_SRCEHypothesis', 'STCRemoteServer', 'DISPID_SLPPhoneIds',
    'ISpLexicon', 'SpeechAddRemoveWord', 'ISpRecoContext2',
    'SREHypothesis', 'tagSPPROPERTYINFO', 'DISPID_SRGRecoContext',
    'DISPID_SpeechGrammarRule', 'SPXRO_Alternates_SML',
    'ISpObjectWithToken', 'SVP_8', 'DISPID_SPPName', 'SDTDisplayText',
    'SPINTERFERENCE_TOOQUIET', 'eLEXTYPE_MORPHOLOGY', 'SP_VISEME_2',
    'SpResourceManager', 'SPEI_FALSE_RECOGNITION', 'SVEAllEvents',
    'SPSTREAMFORMATTYPE', 'SPEI_SOUND_END', 'DISPID_SRCESoundEnd',
    'SP_VISEME_14', 'DISPID_SAFType', 'DISPID_SGRSTNextState',
    'SAFTCCITT_ALaw_44kHzStereo', 'SVSFParseAutodetect',
    'DISPID_SVAudioOutputStream', 'DISPID_SpeechRecoResult',
    'DISPID_SVEAudioLevel', 'DISPID_SPPBRestorePhraseFromMemory',
    'eLEXTYPE_RESERVED9', 'DISPID_SVPause', 'SASStop', 'SREPrivate',
    'DISPID_SPRsItem', 'SAFTADPCM_8kHzMono', 'SpeechRecoEvents',
    'SPCATEGORYTYPE', 'DISPID_SPAs_NewEnum', 'DISPID_SOTsCount',
    'DISPID_SRCRetainedAudioFormat', 'SpeechDiscardType',
    'SpeechVisemeType', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SRRTOffsetFromStart', 'SWTAdded', 'DISPID_SRGRules',
    'ISpNotifyTranslator', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRGCmdLoadFromFile', 'SRSActive', 'DISPID_SVEStreamEnd',
    'SPWORD', 'SPADAPTATIONRELEVANCE', 'SpeechGrammarState',
    'DISPID_SVEViseme', 'SPEI_RECO_STATE_CHANGE', 'SPGS_EXCLUSIVE',
    'SVP_3', 'SREPropertyNumChange', 'SGRSTTDictation', 'SVEBookmark',
    'DISPID_SPRuleName', 'SGDSActive', 'SpeechTokenIdUserLexicon',
    'SVP_15', 'ISpeechVoiceStatus', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPBINARYGRAMMAR', 'SPSUnknown', 'DISPID_SPPValue',
    'DISPID_SRCERequestUI', 'DISPID_SLPPartOfSpeech',
    'SpeechAudioFormatGUIDText', 'DISPID_SRCreateRecoContext',
    'SAFT22kHz16BitStereo', 'DISPID_SMSSetData', 'ISpeechRecoResult',
    'WAVEFORMATEX', 'SpeechRuleAttributes',
    'DISPID_SRGCmdSetRuleState', 'SPAUDIOBUFFERINFO',
    'SAFT22kHz16BitMono', 'SP_VISEME_8', 'ISpeechFileStream',
    'DISPID_SpeechPhraseRule', 'DISPID_SGRSAddSpecialTransition',
    'SpPhraseInfoBuilder', 'SDTAudio', 'DISPID_SRGCmdSetRuleIdState',
    'SPAUDIOSTATE', 'DISPID_SASNonBlockingIO',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SLPLangId',
    'eLEXTYPE_PRIVATE4', 'SFTInput', 'DISPIDSPRG', 'SPSHORTCUTTYPE',
    'DISPID_SDKDeleteKey', 'DISPID_SVSpeakCompleteEvent', 'SVP_12',
    'SPEI_START_INPUT_STREAM', 'ISpeechGrammarRule',
    'SAFTGSM610_44kHzMono', 'DISPID_SASCurrentDevicePosition',
    'SpPhoneticAlphabetConverter', 'SPPHRASEPROPERTY',
    'SRSActiveAlways', 'SLODynamic', 'DISPID_SRCResume',
    'DISPID_SPRuleParent', 'SAFTADPCM_22kHzStereo',
    'DISPID_SGRSTransitions', 'SRSEIsSpeaking', 'SPCS_ENABLED',
    'SAFTADPCM_44kHzMono', 'SVP_20', 'DISPID_SGRAddResource',
    'SpeechCategoryAudioOut', 'DISPID_SRDisplayUI', 'SP_VISEME_19',
    'SASPause', 'DISPID_SVSInputSentencePosition',
    'SpeechCategoryRecognizers', 'DISPID_SVIsUISupported',
    'DISPID_SRRTTickCount', 'STCLocalServer',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPPS_Noncontent',
    'eWORDTYPE_DELETED', 'SPINTERFERENCE_TOOFAST',
    'SpeechCategoryAudioIn', 'DISPID_SRState',
    'DISPID_SpeechXMLRecoResult',
    'SpeechPropertyNormalConfidenceThreshold', 'SPAS_CLOSED',
    'ISpeechCustomStream', 'DISPID_SABufferNotifySize',
    ...
    'eLEXTYPE_PRIVATE16', 'SPEI_TTS_BOOKMARK', 'SRSInactiveWithPurge',
    'SPEI_RESERVED3', '_ISpeechRecoContextEvents',
    'SDA_Consume_Leading_Spaces', 'DISPID_SRStatus',
    'DISPID_SpeechGrammarRules', 'SAFTNoAssignedFormat',
    'ISpeechRecognizer', 'SPEI_SR_PRIVATE', 'SPWF_SRENGINE',
    'SPSHT_OTHER', 'DISPID_SRIsShared', 'SSFMCreate', 'SPXRO_SML',
    'STSF_FlagCreate', 'DISPID_SPRFirstElement',
    'SPFM_OPEN_READWRITE', 'SPPARTOFSPEECH',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRGSetTextSelection',
    'ISpeechBaseStream', 'ISpObjectTokenCategory',
    'DISPID_SpeechAudioBufferInfo', 'ISpDataKey', 'SPSEMANTICFORMAT',
    'DISPID_SpeechVoice', 'SRARoot', 'STCInprocHandler',
    'SpeechGrammarTagUnlimitedDictation', 'SPWT_DISPLAY',
    'DISPID_SPEAudioSizeTime', 'SSSPTRelativeToStart',
    ...
    'SpMMAudioEnum', 'SP_VISEME_6', 'DISPID_SRCSetAdaptationData',
    'ISpGrammarBuilder', 'SPLO_DYNAMIC', 'SP_VISEME_3',
    'DISPID_SBSWrite', 'DISPID_SLAddPronunciation',
    'SpeechInterference', 'ISpPhraseAlt', 'SPRST_INACTIVE_WITH_PURGE',
    'SpeechPartOfSpeech', 'SDTRule', 'DISPID_SPPEngineConfidence',
    ...
    'DISPID_SRCEventInterests', 'SpeechUserTraining', 'SPPS_Verb',
    'DISPID_SpeechLexiconWords', 'SVPAlert',
    'DISPID_SLRemovePronunciation', 'SPWORDPRONOUNCEABLE',
    'SAFT48kHz16BitStereo', 'SVSFPersistXML', 'DISPID_SPEsCount',
    'SPPS_Modifier', 'DISPID_SRRecognizer', 'ISpPhoneConverter',
    'SAFTADPCM_22kHzMono', 'SpeechTokenKeyFiles', 'SPFM_CREATE',
    'SpeechAudioFormatType', 'SPAUDIOOPTIONS', 'eLEXTYPE_USER',
    'DISPID_SLWs_NewEnum', 'DISPID_SASetState', 'SVP_6',
    'DISPID_SVStatus', 'SPAR_High', 'SWPUnknownWordPronounceable',
    'ISpPhoneticAlphabetConverter', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRSSupportedLanguages', 'SPCT_DICTATION',
    'DISPID_SRRSetTextFeedback', 'DISPID_SPEDisplayText',
    'SGRSTTEpsilon', 'DISPID_SPPId', 'SVSFNLPMask', 'DISPID_SPPsItem',
    'DISPID_SGRSTRule', 'DISPID_SCSBaseStream',
    'DISPID_SGRAttributes', 'SVP_17', 'SpPhoneConverter',
    'DISPID_SGRs_NewEnum', 'DISPIDSPTSI_ActiveLength',
    'SpeechGrammarRuleStateTransitionType', 'ISpeechAudioFormat',
    'SVP_10', 'SpeechCategoryRecoProfiles', 'DISPID_SRRSaveToMemory',
    'SPEI_VISEME', 'DISPID_SPERequiredConfidence',
    'DISPID_SGRInitialState', 'SpeechPropertyLowConfidenceThreshold',
    'SP_VISEME_13', 'DISPID_SVEWord', 'ISpeechLexiconPronunciation',
    'DISPID_SLPs_NewEnum', 'SGRSTTRule', 'DISPID_SPRs_NewEnum',
    'SpeechGrammarTagDictation', 'eLEXTYPE_RESERVED7',
    'SVSFNLPSpeakPunc', 'DISPID_SGRName', 'SpeechTokenKeyAttributes',
    'SPEI_RESERVED2', 'DISPID_SPEs_NewEnum', 'SAFT44kHz8BitStereo',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SWFEExtraData', 'SP_VISEME_21',
    'SWTDeleted', 'DISPID_SRCVoice', 'SAFTGSM610_22kHzMono',
    'DISPID_SGRSTPropertyValue', 'DISPID_SVSInputSentenceLength',
    'SpeechAudioVolume', 'eLEXTYPE_RESERVED10', 'ISpeechMMSysAudio',
    'DISPID_SGRsCount', 'DISPID_SAEventHandle', 'SRTStandard',
    'SpLexicon', 'SAFT32kHz8BitStereo', 'ISpeechAudioBufferInfo',
    'SGSExclusive', 'DISPID_SAStatus', 'DISPID_SPEActualConfidence',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SDKLDefaultLocation',
    'SPPS_Noun', 'eLEXTYPE_VENDORLEXICON', 'DISPID_SPPFirstElement',
    'DISPID_SRIsUISupported', 'DISPID_SOTId',
    'SPEI_SENTENCE_BOUNDARY', 'SPSInterjection',
    'SPTEXTSELECTIONINFO', '_RemotableHandle',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SDKCreateKey',
    'DISPID_SpeechPhoneConverter', 'SAFT48kHz8BitStereo',
    'Speech_Max_Word_Length', 'SRTReSent', 'SVSFIsNotXML',
    'DISPID_SVGetAudioInputs', '_ISpeechVoiceEvents',
    'SAFT44kHz16BitStereo', 'SPBO_TIME_UNITS',
    'DISPID_SRSAudioStatus', 'SpeechLoadOption',
    'DISPIDSPTSI_ActiveOffset', 'ISpeechGrammarRuleState',
    'DISPID_SPILanguageId', 'ISpRecognizer', 'DISPID_SFSClose',
    'ISpRecognizer2', 'SpeechDataKeyLocation', 'SASRun',
    'SpeechSpecialTransitionType', 'DISPID_SVGetAudioOutputs',
    'SPWAVEFORMATTYPE', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SLPType', 'SpTextSelectionInformation', 'SITooFast',
    'SAFTCCITT_ALaw_11kHzStereo', 'IInternetSecurityMgrSite',
    'SpeechRecoContextState', 'DISPID_SVESentenceBoundary',
    'DISPID_SpeechVoiceStatus', 'SPWF_INPUT', 'DISPID_SPIGrammarId',
    'ISpSerializeState', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SPIReplacements', 'SAFT16kHz8BitMono', 'SPWT_LEXICAL',
    'SVEPhoneme', 'SAFT48kHz16BitMono',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SVSLastBookmarkId',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SLPsCount', 'SPGS_DISABLED',
    'ISpeechPhraseAlternate', 'SpeechPropertyComplexResponseSpeed',
    'SpeechMicTraining', 'ISpeechPhraseRules',
    'DISPID_SPIGetDisplayAttributes', 'SpInprocRecognizer', 'SVP_4',
    'DISPID_SOTCategory', 'SECFEmulateResult',
    ...
    'SAFTADPCM_44kHzStereo', 'SPCT_SLEEP', 'SPEI_UNDEFINED',
    'DISPID_SLWWord',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPRNumberOfElements', 'SAFT12kHz16BitStereo',
    '__MIDL_IWinTypes_0009', 'ISpeechWaveFormatEx',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SAFSetWaveFormatEx',
    'SPWORDLIST', 'ISpNotifySink', 'DISPID_SpeechAudioStatus',
    'DISPID_SPIProperties', 'SVSFIsFilename', 'SVP_1',
    'SpeechRetainedAudioOptions', 'SPPS_NotOverriden',
    'DISPID_SRRTStreamTime', 'eLEXTYPE_USER_SHORTCUT', 'SPAS_RUN',
    'SSSPTRelativeToEnd', 'SVSFIsXML', 'Speech_Default_Weight',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVESentenceBoundary',
    'SpeechVoiceEvents', 'DISPID_SpeechPhraseInfo',
    'DISPID_SGRsDynamic', 'SPPS_Unknown', 'DISPID_SOTCId',
    'SPWT_PRONUNCIATION', 'DISPID_SPEAudioStreamOffset',
    'SRTSMLTimeout', 'SPVPRI_NORMAL',
    'DISPID_SpeechLexiconPronunciation', 'SAFT22kHz8BitStereo',
    'SpeechTokenShellFolder', 'DISPIDSPTSI', 'SVSFVoiceMask',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPEI_MAX_SR', 'SP_VISEME_16',
    ...
    'SAFTCCITT_uLaw_8kHzStereo', 'SVPNormal', 'DISPID_SOTCSetId',
    'SAFT48kHz8BitMono', 'DISPID_SPRText', 'ISpeechLexiconWords',
    'SGLexicalNoSpecialChars', 'DISPID_SPARecoResult',
    'eLEXTYPE_PRIVATE5', 'SPBO_NONE', 'Speech_StreamPos_Asap',
    'SpAudioFormat', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFTDefault', 'SBOPause', 'SLTUser', 'DISPID_SGRId',
    'SPCS_DISABLED', 'SECFNoSpecialChars', 'DISPID_SOTs_NewEnum',
    'eLEXTYPE_PRIVATE20', 'SPSMF_UPS', 'ISpEventSource',
    'SAFTCCITT_uLaw_11kHzMono', 'SPPS_RESERVED1',
    'DISPID_SpeechBaseStream', 'SPRS_ACTIVE', 'DISPID_SRGState',
    'DISPID_SPEAudioSizeBytes', 'SVP_13', 'SSFMOpenReadWrite',
    'DISPID_SPEPronunciation', 'SPDKL_CurrentUser', 'STCInprocServer',
    'SPAUDIOSTATUS', 'SPVPRIORITY', 'SPEI_RESERVED1', 'ISpEventSink',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SPAPhraseInfo',
    'SRTAutopause', 'SRERequestUI', 'SPDATAKEYLOCATION',
    'SPPS_SuppressWord', 'DISPID_SRCCreateResultFromMemory',
    ...
    'SAFT8kHz16BitMono', 'DISPID_SDKSetStringValue',
    'SPAO_RETAIN_AUDIO', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPPParent', 'SVSFParseMask',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SPELexicalForm',
    'SVEEndInputStream', 'Speech_StreamPos_RealTime', 'ISpeechAudio',
    'SSTTDictation', 'SPSERIALIZEDRESULT', 'SAFTExtendedAudioFormat',
    'SECFDefault', 'DISPID_SDKOpenKey', 'SPWORDPRONUNCIATION',
    'SpeechEmulationCompareFlags', 'SVEAudioLevel', 'SITooLoud',
    'DISPID_SRCAudioInInterferenceStatus', 'SPEVENTSOURCEINFO',
    'SPSERIALIZEDPHRASE', 'SPSNotOverriden', 'DISPID_SDKGetlongValue',
    'SPVPRI_ALERT', 'DISPID_SRSCurrentStreamNumber',
    'SpeechCategoryVoices', 'SPRECOGNIZERSTATUS',
    'DISPID_SPEAudioTimeOffset', 'eLEXTYPE_RESERVED6', 'SPVISEMES',
    'DISPID_SGRsCommitAndSave', 'SpeechAllElements',
    'SPPS_Interjection', 'SPPHRASEELEMENT', 'SAFT44kHz8BitMono',
    'DISPID_SWFEChannels', 'SPDKL_LocalMachine',
    'DISPID_SpeechFileStream', 'SRAExport', 'SpWaveFormatEx',
    ...
    'DISPID_SVPriority', 'ISpeechRecoResult2', 'SVSFPurgeBeforeSpeak',
    'DISPID_SLPsItem', 'SBONone', 'SP_VISEME_7',
    ...
    'SECNormalConfidence', 'SP_VISEME_12', 'SPEI_TTS_PRIVATE',
    'SRESoundStart', 'SREPhraseStart', 'SAFT16kHz8BitStereo',
    'SpeechLexiconType', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SLWLangId',
    'eLEXTYPE_PRIVATE3', 'SRTEmulated', 'SPEI_HYPOTHESIS',
    'SGRSTTWildcard', 'SGPronounciation', 'SECFIgnoreCase',
    'SPVPRI_OVER', 'ISpStreamFormat', 'SPSFunction',
    'DISPID_SRGCommit', 'SpStreamFormatConverter', 'DISPID_SBSRead',
    'SPEI_MIN_TTS', 'SDA_No_Trailing_Space',
    ...
    'SAFTNonStandardFormat', 'DISPID_SGRsCommit', 'SGSEnabled',
    'DISPID_SGRClear', 'SVEPrivate', 'SAFT24kHz8BitMono',
    'DISPID_SpeechGrammarRuleState',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SpeechCustomStream',
    'IEnumSpObjectTokens', 'SpMMAudioIn', 'SREAllEvents',
    'ISpeechObjectTokens', 'SSFMOpenForRead',
    'ISpeechPhraseReplacements', 'DISPID_SPAsItem',
    'SPEI_RECOGNITION', 'SDTAll', 'SPGRAMMARWORDTYPE',
    'SAFTCCITT_ALaw_11kHzMono', 'SPEI_PHRASE_START',
    'DISPID_SpeechRecoContext', 'SPEVENTENUM', 'SECFIgnoreKanaType',
    'SVP_2', 'DISPID_SAVolume', 'SRSEDone', 'eLEXTYPE_PRIVATE13',
    'SPINTERFERENCE_NONE', 'SAFT32kHz16BitStereo',
    'DISPID_SREmulateRecognition', 'DISPID_SRCCmdMaxAlternates',
    'SpeechStreamFileMode', 'SpObjectToken', 'SPAS_PAUSE',
    'SpSharedRecoContext', 'DISPID_SpeechPhraseRules', 'SP_VISEME_1',
    'DISPID_SASFreeBufferSpace', 'SPPS_RESERVED3', 'ISpStream',
    'DISPID_SPIRetainedSizeBytes', 'SVSFParseSsml', 'SDTProperty',
    'ISpeechLexiconPronunciations', 'DISPID_SRRSpeakAudio',
    'SpeechEngineConfidence', 'SRADefaultToActive',
    'DISPID_SDKSetLongValue', 'DISPID_SpeechPhraseElement',
    'SREBookmark', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SLWPronunciations', 'ISpeechVoice', 'ISpPhrase',
    'ISpeechPhraseProperty', 'SAFTGSM610_11kHzMono',
    'DISPID_SOTGetStorageFileName', 'DISPID_SRSetPropertyNumber',
    'ISpeechRecoResultTimes', 'DISPID_SVSLastBookmark',
    'SpeechPropertyAdaptationOn', 'SPRST_NUM_STATES',
    'eLEXTYPE_PRIVATE6', 'SLOStatic', 'SP_VISEME_9',
    'DISPID_SPIAudioSizeTime', 'SITooQuiet', 'DISPID_SPIGetText',
    'SVF_None', 'SREStateChange', 'SVP_19', 'SVEWordBoundary',
    ...
    'DISPID_SMSALineId', 'ISpeechPhraseElement',
    'SREPropertyStringChange', 'DISPID_SBSFormat', 'SVP_11',
    'DISPID_SRCPause', 'SRAImport', 'IEnumString',
    'eLEXTYPE_PRIVATE7', 'SECHighConfidence', 'eLEXTYPE_PRIVATE11',
    'DISPID_SpeechObjectTokenCategory', 'ISpeechXMLRecoResult',
    'SPRECOSTATE', 'DISPID_SpeechRecoResult2', 'SpCompressedLexicon',
    'SDA_Two_Trailing_Spaces', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRCVoicePurgeEvent', 'IInternetSecurityManager',
    'SPRECORESULTTIMES', 'ISpeechDataKey', 'SVP_18',
    'ISpeechObjectToken', 'ISpeechPhraseRule', 'DISPID_SOTSetId',
    'DISPID_SRRTimes', 'SAFT16kHz16BitStereo', 'DISPID_SpeechAudio',
    'SpeechTokenKeyUI', 'SWPUnknownWordUnpronounceable',
    'SPLOADOPTIONS', 'DISPID_SOTGetAttribute', 'DISPID_SVRate',
    'SPPS_RESERVED2', 'DISPID_SpeechGrammarRuleStateTransition',
    ...
    'DISPID_SpeechObjectToken', 'SPEI_RESERVED6', 'SpVoice',
    'SPEI_TTS_AUDIO_LEVEL', 'SAFT11kHz16BitMono',
    'DISPID_SRCEFalseRecognition', 'DISPID_SLGenerationId',
    'SSTTTextBuffer', 'ISpeechPhraseProperties',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SGRSTsCount',
    'SITooSlow', 'DISPID_SVGetProfiles', 'SPEI_VOICE_CHANGE',
    'DISPID_SRCERecognition', 'SPSNoun', 'DISPID_SRGDictationLoad',
    'SRTExtendableParse', 'ISpRecoCategory', 'DISPID_SBSSeek',
    'eLEXTYPE_PRIVATE2', 'DISPID_SRGetFormat', 'SVF_Emphasis',
    'SINoSignal', 'eLEXTYPE_PRIVATE18', 'DISPID_SVWaitUntilDone',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SDKLLocalMachine',
    'SPRULE', 'DISPID_SPEDisplayAttributes',
    'SAFTCCITT_ALaw_44kHzMono', 'SRERecognition',
    'DISPID_SRRAlternates', 'SP_VISEME_10',
    'DISPID_SRGDictationUnload', 'DISPID_SRGDictationSetState',
    'SGRSTTWord', 'DISPID_SGRSTPropertyName', 'SPCT_COMMAND',
    'DISPID_SOTCreateInstance', 'SAFT12kHz16BitMono',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPBO_PAUSE',
    'DISPID_SpeechMemoryStream', 'SpeechStreamSeekPositionType',
    'SPEI_START_SR_STREAM', 'eLEXTYPE_PRIVATE10',
    'ISpeechTextSelectionInformation', 'ISpRecoGrammar2',
    'SpeechVoiceSkipTypeSentence', 'SVP_16', 'DISPID_SADefaultFormat',
    'ISpShortcut', 'SpUnCompressedLexicon', 'DISPID_SPRuleConfidence',
    ...
    'eWORDTYPE_ADDED', 'SDTReplacement', 'SPRECOCONTEXTSTATUS',
    'DISPID_SAFGetWaveFormatEx', 'SpeechRegistryUserRoot',
    'SPEI_SOUND_START', 'DISPID_SWFEAvgBytesPerSec',
    'SPSSuppressWord', 'SPPS_Function', 'SP_VISEME_4',
    'SpCustomStream', 'ISpeechRecoResultDispatch', '_SPAUDIOSTATE',
    'SpeechFormatType', 'STCAll', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SLAddPronunciationByPhoneIds', 'SP_VISEME_15', 'SVP_14',
    ...
    'SPBOOKMARKOPTIONS', 'SPAR_Unknown', 'DISPID_SABIMinNotification',
    'ISpObjectToken', 'SAFT8kHz8BitStereo',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRCEStartStream',
    'DISPID_SDKEnumValues', 'SAFTADPCM_11kHzStereo',
    'SGDSActiveUserDelimited',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRAudioInputStream', 'SPEI_MAX_TTS', 'DISPID_SPAsCount',
    'SP_VISEME_17', 'DISPID_SRGCmdLoadFromObject', 'SPRST_ACTIVE',
    'DISPID_SRCEAudioLevel', 'SpeechRegistryLocalMachineRoot',
    'SPCONTEXTSTATE', 'ISpVoice', 'DISPID_SGRsFindRule',
    'ISpPhoneticAlphabetSelection', 'SPFM_OPEN_READONLY',
    'SRADynamic', 'SINoise', 'DISPID_SRCEPropertyNumberChange',
    'ISpeechAudioStatus', 'SAFTGSM610_8kHzMono', 'DISPID_SDKEnumKeys',
    'IStream', 'SAFTCCITT_ALaw_8kHzStereo', 'eLEXTYPE_PRIVATE9',
    'DISPID_SGRSAddWordTransition', 'ISpeechResourceLoader',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRGSetWordSequenceData',
    'SpeechCategoryAppLexicons', 'SSTTWildcard',
    'DISPID_SOTGetDescription', 'DISPID_SASState',
    'DISPID_SPIEngineId', 'eLEXTYPE_PRIVATE8', 'DISPID_SVAudioOutput',
    'DISPID_SVDisplayUI', 'SRCS_Enabled', 'DISPID_SRCRequestedUIType',
    'SPSHT_EMAIL', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SLGetGenerationChange', 'SAFT32kHz8BitMono',
    'DISPID_SOTRemove', 'DISPID_SpeechObjectTokens',
    'eLEXTYPE_RESERVED8', 'STSF_CommonAppData',
    'SpeechTokenValueCLSID', 'ISpeechLexiconWord',
    'SPINTERFERENCE_NOISE', 'SVEViseme', 'DISPID_SFSOpen',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPPConfidence',
    'SpeechVoiceSpeakFlags', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SGRSTWeight', 'SPXMLRESULTOPTIONS', 'SPFM_NUM_MODES',
    'SPRST_ACTIVE_ALWAYS', 'SPAO_NONE', 'SPFILEMODE',
    ...
    'DISPID_SRCEEnginePrivate', 'SVP_5', 'SGDSActiveWithAutoPause',
    'DISPID_SRGIsPronounceable', 'DISPID_SPERetainedSizeBytes',
    'ISpeechGrammarRules', 'ISpeechMemoryStream', 'SPSHT_Unknown',
    'DISPID_SpeechPhraseProperties', 'DISPID_SWFEFormatTag',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SVEPhoneme',
    'DISPID_SRGetPropertyString', 'DISPID_SRCState',
    'DISPID_SOTCGetDataKey', 'DISPID_SpeechAudioFormat',
    'DISPID_SWFEBlockAlign', 'DISPID_SPRulesItem',
    'DISPID_SpeechLexiconWord', 'ISpeechObjectTokenCategory',
    'DISPID_SRRDiscardResultInfo', 'SECLowConfidence', 'SPWORDTYPE',
    'DISPID_SRCRetainedAudio', 'DISPID_SPRuleId', 'SP_VISEME_11',
    'SPCT_SUB_COMMAND', 'SPEI_WORD_BOUNDARY', 'SpeechWordType',
    'SPFM_CREATE_ALWAYS', 'DISPID_SPRuleFirstElement',
    'DISPID_SRRPhraseInfo', 'SPBO_AHEAD', 'DISPID_SABIEventBias',
    'SAFTCCITT_uLaw_44kHzMono', 'SVSFParseSapi', 'SGDisplay',
    'LONG_PTR', 'DISPID_SRCEInterference', 'SVF_Stressed',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SpeechRecoContextEvents',
    'ISpeechPhraseElements', 'SpMMAudioOut', 'DISPID_SRRGetXMLResult',
    'DISPID_SMSGetData', 'DISPID_SVSLastResult', 'SAFT22kHz8BitMono',
    'ISpeechRecoContext', 'DISPID_SDKDeleteValue', 'SVSFUnusedFlags',
    'SPDKL_DefaultLocation', 'SPGRAMMARSTATE', 'SINone',
    'SSFMCreateForWrite', 'SPPROPERTYINFO', 'DISPID_SpeechMMSysAudio',
    'ISpAudio', 'SPRS_INACTIVE', 'SpeechBookmarkOptions',
    'SpeechVisemeFeature', 'SAFTText', 'DISPID_SRRRecoContext',
    'DISPID_SVSpeak', 'DISPID_SRAudioInput', 'DISPID_SGRAddState',
    'SPPS_RESERVED4', 'SPPHRASE', 'SPSLMA', 'SREStreamStart',
    'SpObjectTokenCategory', 'DISPID_SPRulesCount', 'DISPID_SRRAudio',
    'eLEXTYPE_PRIVATE14', 'SpeechRuleState', 'SPEVENT',
    'DISPID_SOTsItem', 'SGSDisabled', 'SVP_0', 'SVPOver',
    'ISpeechPhraseInfo', 'SRCS_Disabled', 'SREFalseRecognition',
    'DISPID_SpeechVoiceEvent', 'SPEI_PHONEME',
    'DISPID_SRCEPhraseStart', 'SREAdaptation', 'SPLO_STATIC',
    'SPEI_END_SR_STREAM', 'SpeechGrammarTagWildcard',
    'DISPID_SVVolume', 'SGDSInactive', 'DISPID_SPPNumberOfElements',
    'SpNotifyTranslator', 'SAFTCCITT_ALaw_8kHzMono', 'SRESoundEnd',
    'DISPID_SRGId', 'SVSFDefault', 'DISPID_SPPsCount',
    'DISPID_SVResume', 'SPEI_ADAPTATION',
    'DISPID_SRGetPropertyNumber', 'SRERecoOtherContext',
    'DISPID_SPIRule', 'SGRSTTTextBuffer', 'SAFT8kHz16BitStereo',
    'SRAInterpreter', 'SPAR_Medium', 'DISPID_SPCPhoneToId',
    'DISPID_SRGetRecognizers', 'ISpeechPhraseAlternates',
    'DISPID_SOTCDefault', 'DISPID_SABIBufferSize', 'DISPID_SLWsItem',
    'DISPID_SRProfile', 'SPPHRASERULE', 'SpeechPropertyResourceUsage',
    'SpeechDisplayAttributes', 'ISpRecognizer3',
    'ISpeechPhoneConverter', 'SRSInactive', 'DISPID_SpeechDataKey',
    'DISPID_SABufferInfo', 'SPVOICESTATUS',
    'DISPID_SpeechPhraseElements', 'DISPID_SPRules_NewEnum',
    'eLEXTYPE_PRIVATE19', 'SPRULESTATE', 'SPRST_INACTIVE',
    'DISPID_SLWType', 'DISPID_SVSVisemeId', 'DISPID_SLWsCount'
]

_check_version('1.1.14', 1654584796.930282)
