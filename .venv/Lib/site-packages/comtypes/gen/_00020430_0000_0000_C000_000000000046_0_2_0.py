...
__all__ = [
    'StdFont', 'Default', 'StdPicture', 'LoadPictureConstants',
    'Unchecked', 'OLE_XSIZE_PIXELS', 'OLE_ENABLEDEFAULTBOOL',
    'OLE_COLOR', 'FONTNAME', 'OLE_XSIZE_HIMETRIC', 'OLE_CANCELBOOL',
    'OLE_YPOS_CONTAINER', 'FontEvents', 'Monochrome', 'FONTITALIC',
    'Checked', 'OLE_YSIZE_PIXELS', 'Font', 'OLE_YPOS_HIMETRIC',
    'OLE_TRISTATE', 'FONTSTRIKETHROUGH', 'IPicture',
    'OLE_YPOS_PIXELS', 'OLE_OPTEXCLUSIVE', 'FONTBOLD', 'OLE_HANDLE',
    'Gray', 'IFont', 'FONTUNDERSCORE', 'OLE_XSIZE_CONTAINER',
    'Picture', 'VgaColor', 'OLE_XPOS_HIMETRIC', 'IFontEventsDisp',
    'IPictureDisp', 'OLE_XPOS_PIXELS', 'IFontDisp',
    'OLE_YSIZE_HIMETRIC', 'Color', 'FONTSIZE', 'OLE_YSIZE_CONTAINER',
    'OLE_XPOS_CONTAINER'
]

_check_version('1.1.14', 1654584747.445572)
